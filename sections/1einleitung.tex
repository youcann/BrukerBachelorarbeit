...
\begin{figure}[H]
	\centering
	\subcaptionbox[Erste MRT-Aufnahme]{Eine der ersten \gls{mrt}-Aufnahmen eines lebendigen Menschens; 1977; Farbe kodiert Signalstärke; \cite{damadian1977}}{\includegraphics[width=0.4\textwidth]{img/fonarImage.PNG}}
	\hfill
	\subcaptionbox[Hochauflösende MRT Aufnahme einer Maus]{Hochauflösende \gls{mrt}-Aufnahme einer Maus; 2013;  \cite{rascheUlm}}{\includegraphics[width=0.4\textwidth]{img/mouseBrain.PNG}}
