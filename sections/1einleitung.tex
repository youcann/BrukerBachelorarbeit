...
\begin{figure}[H]
	\centering
	\subcaptionbox[Erste MRT-Aufnahme]{Eine der ersten \gls{mrt}-Aufnahmen eines lebendigen Menschens; 1977; Farbe kodiert Signalstärke; \cite{damadian1977}}{\includegraphics[width=0.4\textwidth]{img/ext/fonarImage.PNG}}
	\hfill
	\subcaptionbox[Hochauflösende MRT Aufnahme einer Maus]{Hochauflösende \gls{mrt}-Aufnahme einer Maus; 2013;  \cite{rascheUlm}}{\includegraphics[width=0.4\textwidth]{img/ext/mouseBrain.PNG}}
...
Im Segment der präklinischen Bildgebung ist die (mikro) \gls{mrt} die wichtigste Modalität. Bruker BioSpin ist auf dem Markt der präklinischen Bildgebungssysteme Marktführer. Die wichtigsten Mitbewerber sind \textit{Aspect Imaging} und \textit{MR Solutions}.
