...
Nach \cite{Bushberg2011} gilt bei einem Schichtbild, dass mit einer Spinecho-Sequenz aufgenommen wird, für die Pixelintensität (mit $\rho=PD$):
\begin{equation}
...
Da der Großteil der Leistung im Träger steckt, kann meist die Gesamtleistung mit der Trägerleistung gleichgesetzt werden. Damit wird $\mathscr{L}$ in Decibel:
\begin{equation}
	\mathscr{L}_{dBc}(f) = P_{n, dBm/Hz} - P_{s, dBm}
\end{equation}

\section{Jitter}
Jitter ist definiert als:
