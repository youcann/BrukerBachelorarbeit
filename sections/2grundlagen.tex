...
\begin{figure}[H]
	\centering
	\resizebox{0.8\textwidth}{!}{\includegraphics[]{img/phaseNoiseMeasurement_Mixer.tikz}}
	\caption[ph]{Mixer}
...
\begin{figure}[H]
	\centering
	\resizebox{0.4\textwidth}{!}{\includegraphics[]{img/phaseNoiseMeasurement_SpectrumAnalyzer.tikz}}
